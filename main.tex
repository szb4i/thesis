...
\newcommand*{\getFaculty}{Physics of Biomedical Imaging}
\newcommand*{\getTitle}{Vessel Enhancement in Digital Variance Angiographic Imaging}
\newcommand*{\getTitleGer}{}
\newcommand*{\getAuthor}{Szabolcs Nagy}
\newcommand*{\getDoctype}{Master's Thesis}
\newcommand*{\getSupervisorExternal}{Dr. Szabolcs Osvath}
\newcommand*{\getSupervisorTum}{Prof. Dr. Julia Herzen}

...
In this chapter, the theoretical background of the thesis is introduced. First, \gls{dva} is described briefly, then it is shown how \gls{dsa} differs from the prior approach. Next, it is shown how intensity transformations can be utilized to enhance crucial image features. Later, spatial and frequency domain filtering techniques are presented. In the end of the chapter, further methods are discussed which do not fall into the previously mentioned categories.

...
There are different methods to create a final image containing blood vessels only (angiogram). First, the more popular technique, Digital Subtraction Angiography (\gls{dsa}) is discussed.

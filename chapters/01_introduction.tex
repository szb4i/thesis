...
Spatial filtering refers to transformation techniques based on direct manipulation of pixels in an image. One method is to apply intensity transformations, which are expressed as follows:
...
When equalization is not performed globally, this method can be more effective.
